            ...
            <div style={{
                ...
                <div style={{ width: '100%' }} >
                    ...
                    <div style={{ color: '#7B7B7B' }} >
                        <p>• 오너님의 공간이 보장 받을 수 있도록 <span style={{ fontWeight: '700' }} >'마감 가이드'</span>를 주는 단계입니다.</p>
                        <p>• 마감 후 공간이 어떠한 상태였으면 좋겠는지 <span style={{ fontWeight: '700' }} >'글과 사진으로'</span> 상세하게 기록해 주세요!</p>
                    </div>
                </div>
                <div>

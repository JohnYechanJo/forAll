        ...
        <div>
            ...
            <div style={{paddingLeft: "1rem", paddingRight: "1rem", width: "22.375rem", height: "62.5rem", flexShrink: "0"}}>
                ...
                <div>
                    ...
                    <p style={{fontWeight: "400", fontSize: "0.625rem"}}>• 등록 방법은 <a style={{fontWeight: "700", textDecorationLine: "underline"}}>‘우측 상단 바’ 클릭
                    ...
                    <p style={{fontWeight: "400", fontSize: "0.625rem"}}>• For ALL은 요식업 공간뿐만 아니라 공유주방, 교육기관 등 다양한 공간 및 기관과도 제휴를 맺어 파트너십을 이어
                        나가고 있습니다.</p>
                    <p style={{fontWeight: "400", fontSize: "0.625rem"}}>• 지금 바로 ‘공간 등록’을 통해 업주님의 공간을 선보이세요!</p>
                    <p style={{fontWeight: "400", fontSize: "0.625rem"}}>• 이외의 문의 사항은 <a style={{fontWeight: "700", textDecorationLine: "underline"}}>‘우측 상단

...
const ChefRegistryFirst = () => {
    ...
    return (
        <div style={{
            ...
            <a style={{ fontSize: "1.25rem", fontWeight: "700", }} >{name}님, 대관을 위해서 셰프 등록을</a>
            ...
            <button onClick={() => { navigate("/chefRegistry"); }} className="bottom_button" style={{ backgroundColor: "#FF4F4F", position: "fixed" }} >셰프 등록하기</button>

        </div>
    )
};
export default ChefRegistryFirst;

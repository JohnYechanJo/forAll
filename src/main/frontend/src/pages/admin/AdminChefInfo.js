    ...
    return(
        <div
            ...
            <div>
                ...
                <p>
                    <ImageViewer setImg={setSanitaryImage} val={sanitaryImage}/>
                </p>
                ...
                <div style={{display: "flex", justifyContent: "left"}} >
                    <div style={{display: 'flex', marginTop: '1.5rem'}}>
                        ...
                        <div style={{display: 'flex', flexDirection: 'column', marginLeft: '1rem'}}>
                            ...
                            <input disabled={true}
                                onChange={onChangeAccount} className="input" style={{width: '100%'}}
                                   placeholder={"454102-01-376503"}/>
                        </div>
                        <div style={{display: 'flex', flexDirection: 'column', marginLeft: '1rem'}}>
                            <a>예금주<span style={{color: "#FF2929"}}>*</span></a>
                            <input disabled={true}
                                onChange={onChangeAccountHolder} className="input" style={{width: '100%'}}/>
                        </div>
                    </div>
                </div>
                <div style={{gap: "0px"}}>
                    ...
                    <Modal isOpen={isModalOpen} style={ModalStyles} ariaHideApp={false}>
                        <div style={{
                            ...
                            justifyContent: 'center',
                            height: '80%'
                        }}>현재 필수 입력사항이 모두 기입되지 않았습니다!
                        </div>
                        <button className="bottom_button"
                                style={{backgroundColor: '#FF4F4F', position: 'fixed', marginBottom: '0'}}
                                onClick={() => setIsModalOpen(false)}>마저 입력하기
                        </button>
                    </Modal>
                </div>
            </div>
            ...
            <button onClick={handleButton} className="bottom_button"
                    style={{backgroundColor: "#FF4F4F", position: "fixed"}}>저장 후 닫기
            </button>
        </div>
    );
}

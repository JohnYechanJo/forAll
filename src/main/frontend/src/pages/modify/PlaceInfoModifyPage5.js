...
const PlaceInfoModifyPage5 = () => {
    ...
    return (
        <div style={{ display: 'flex', flexDirection: 'column', height: '100vh' }}>
            <ForAllLogo />
            <p style={{ textAlign: 'center'}}>(3/4) 마감 안내</p>
            <div style={{
                display: "flex",
                ...
                <div style={{ width: '100%' }} >
                    ...
                    <hr style={{ height: '2px', width: '100%', backgroundColor: 'black' }} />
                ...
                <div>
                    ...
                    <textarea
                        minLength="20"
                        className="input" style={{ height: '6.25rem', letterSpacing: '-0.0255rem', width: '92vw' }} value={closeGuide} onChange={onChangeGuide} placeholder={

                ...
                <p>
                    ...
                    >
                        ...
                        <div style={{textAlign:'left',wordWrap:'break-word',width:'21.875rem'}} >
                            <p style={{fontWeight:'700'}} >• 제 1장 총칙</p>
                        ...
                        <div onClick={()=>{
                            ...
                            right: "5%",
                            bottom: "5%",
                            fontSize:'0.9375rem',fontWeight:'700',textDecorationLine:'underline',textAlign:'right'}}>확인</div>
                    </Modal>
                </p>
            </div>
            <div>
                <p>
                    ...
                    >
                        ...
                        <div style={{textAlign: 'left', wordWrap: 'break-word', width: '21.875rem'}}>
                            <p style={{fontSize: '0.625rem'}}>1.수집 목적 : 회원 가입의사 확인, 이용자 식별 및 본인여부, 회원자격 유지·관리, 계약 이행 및
                                약관변경 고지를 위한 연락, 본인의사 화인 및 민원 처리,
                                부정이용 방지, 비인가 사용방지, 서비스 제공 및 계약의 이행,서비스 이용 및 상담, 문의, 후기를 위한 원활한 의사소통 경로 확보, 맞춤형 서비스 제공,
                                거점 기반 서비스 제공</p>
                            <p style={{fontSize: '0.625rem'}}>
                                2.수집 항목 : 이름, 아이디, 비밀번호, 휴대폰 번호, 이메일, 성별</p>
                            <p style={{fontSize: '0.625rem'}}>3.보유기간 : 회원 탈퇴 즉시 파기, 부정이용 방지를 위하여 3개월 동안 보관(아이디, 휴대폰 번호)
                                후 파기</p>
                            <p style={{fontSize: '0.625rem'}}>4.수집 목적 : 서비스방문 및 이용기록 분석, 부정이용 방지를 위한 기록 관리, 앰 서비스 이용자
                                식별, 맞춤형 서비스 제공</p>
                            <p style={{fontSize: '0.625rem'}}>5.수집 항목 : 서비스 이용 과정 중 자동 수집*- 서비스 이용기록, 방문 기록, 불량 이용기록,
                                IP주소, 쿠키, MAC주소,
                ...
                <p>
                    <div style={{
                        ...
                        <div>
                            ...
                            <label for="infoThird"
                                   style={{fontWeight: '500', display: 'flex', alignItems: 'center'}}><em
                                style={{height: '1rem'}}></em><span style={{height: '1rem'}}>
                    ...
                    >
                        ...
                        <div onClick={()=>{
                            ...
                            right: "5%",
                            bottom: "5%",fontSize:'0.9375rem',fontWeight:'700',textDecorationLine:'underline',textAlign:'right'}}>확인</div>
                    </Modal>
                </p>
            </div>
            <div>
